...
def linear_eigen_triangulation(u1, P1, u2, P2):
    """
...
iterative_LS_triangulation_tolerance = 3.e-5    # depth convergence tolerance

def iterative_LS_triangulation(u1, P1, u2, P2):
    """
    ...
    for xi in range(len(u1)):
        ...
        for i in range(10):    # Hartley suggests 10 iterations at most
            ...
            if abs(d1_new - d1) <= iterative_LS_triangulation_tolerance and \
                    ...
                    #abs(d1_new - d1) <= iterative_LS_triangulation_tolerance and \    # TODO: remove
                    #abs(d2_new - d2) <= iterative_LS_triangulation_tolerance:    # TODO: remove
